            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-8 offset-lg-2">
                        ...
                        <p className="section-subtitle text-muted text-center font-secondary padding-t-30">Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean class at a euismod mus luctus quam.</p>
                    </div>
                </div>
                    ...
                    <div className="col-lg-4">
                        <div className="blog-box margin-t-30">
                            ...
                            <div>
                                ...
                                <h4 className="mt-3"><Link to="#" onClick={evt => {  evt.preventDefault(); } } className="blog-title"> Doing a cross country road trip </Link></h4>
                                <p className="text-muted">She packed her seven versalia, put her initial into the belt and made herself on the way..</p>
                                <div className="mt-3">
                                    <Link to="#" onClick={evt => {  evt.preventDefault(); } } className="read-btn">Read More <i className="mdi mdi-arrow-right"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4">
                        <div className="blog-box margin-t-30">
                            ...
                            <div>
                                ...
                                <h4 className="mt-3"><Link to="#" onClick={evt => {  evt.preventDefault(); } } className="blog-title">New exhibition at our Museum</Link></h4>
                    ...
                    <div className="col-lg-4">
                        <div className="blog-box margin-t-30">
                            ...
                            <div>
                                ...
                                <h4 className="mt-3"><Link to="#" onClick={evt => {  evt.preventDefault(); } } className="blog-title">Why are so many people..</Link></h4>
